...
- The kernel_comp.gap file contains the code that produces the csv files. It takes as input a number d and outputs a list of all the possible wreath products that can appear in degree d together with what the kernel of the associated map is (see Remark 3.3.17 in the thesis for details). The code therein is inspired by code sent to me by Hoshi and Yamasaki.
